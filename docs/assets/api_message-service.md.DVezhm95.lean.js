import{aZ as i,aL as s,u as p,v as e,H as r,I as o,bk as c}from"./chunks/framework.7BQS5fsx.js";const d=`openapi: "3.0.3"
info:
    ...
    CommonResponse:
      ...
      properties:
        ...
        data:
          ...
          description: 响应数据
          nullable: true
`,u=JSON.parse('{"title":"消息服务","description":"","frontmatter":{"title":"消息服务","aside":false},"headers":[],"relativePath":"api/message-service.md","filePath":"api/message-service.md"}'),a={name:"api/message-service.md"},_=Object.assign(a,{setup(m){return(y,n)=>{const t=i("OASpec");return s(),p("div",null,[n[0]||(n[0]=e("h1",{id:"消息服务",tabindex:"-1"},[r("消息服务 "),e("a",{class:"header-anchor",href:"#消息服务","aria-label":'Permalink to "消息服务"'},"​")],-1)),o(t,{spec:c(d),"hide-branding":""},null,8,["spec"])])}}});export{u as __pageData,_ as default};
